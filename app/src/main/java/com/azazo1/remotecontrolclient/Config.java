...
public class Config {
    ...
    public static final String version = "1.0.20220227"; // 版本号
    ...
    public static final String algorithmAll = "AES/CBC/PKCS5Padding"; // 加密算法（细节）
    public static final int serverPort = 2004; // 局域网服务器端口
    public static final int timeout = 5000; // 套接字超时时间
    public static final int ipSearchingThread = 30; // IP搜索线程数
